...
class Dockerfile extends DefaultTask {
    ...
    void healthcheck(String script) {
    ...
    static class HealthCheckInstruction extends StringCommandInstruction {
        HealthCheckInstruction(String script) {
            super(script)
        }

        HealthCheckInstruction(Closure script) {
            super(script)
        }
