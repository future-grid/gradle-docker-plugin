Gradle Docker plugin (I'm not the owner, just copy it and did some changes for myself...)
====================
Go to the official website to get the what you want!

Please look at the following message!
